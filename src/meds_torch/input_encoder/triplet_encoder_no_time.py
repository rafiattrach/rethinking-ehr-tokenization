...
class TripletEncoder(nn.Module, Module):
    ...
    MODIFIED FOR RQ1: Excludes time embedding from triplet representation to test impact of time component.
    ...
    def __init__(self, cfg: DictConfig):
        ...
        # NOTE: date_embedder is kept for compatibility but won't be used in final embedding
    ...
    def get_embedding(self, batch):
        ...
        # RQ1 NO-TIME: Comment out time embedding to test impact of temporal information
        ...
        # RQ1 NO-TIME: Sum only (code, value) pairs, excluding time component
